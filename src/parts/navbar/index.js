                ...
                <Container>
                    ...
                    <div className="d-flex gap-3 align-items-center">
                        <Link to="/cart" className="position-relative text-white">
                            ...
                            <p className="bg-danger rounded-circle border border-light px-1 position-absolute top-0 end-0" style={{fontSize:"10px"}}>{ state.user && state.user.cart_item?.length > 0 ? state?.user.cart_item.length : ""}</p>
                        </Link>
